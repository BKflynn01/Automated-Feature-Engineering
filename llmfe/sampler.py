...
class Sampler:
    ...
    def sample(self, **kwargs):
        ...
        while True:
            ...
            if (
                self._max_sample_nums // 5
                and self.__class__._global_samples_nums >= self._max_sample_nums // 5
            ):
                break
...
class LocalLLM(LLM):
    def __init__(self, samples_per_prompt: int, batch_inference: bool = True, trim=True) -> None:
        ...
        instruction_prompt_3 = (
            "You are an assistant specializing in analyzing data which will be given the following:\n"
